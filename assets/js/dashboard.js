...
.factory('ViewsService', function() {
  var _views = [
        ...
        {label:'Mi Perfil', icon: 'fa-user', separator: false},
        {label:'Grupos', icon: 'fa-file-text', separator: false},
        {label:'Estadística', icon: 'fa-bar-chart', separator: false},
        {label:'Configuración', icon: 'fa-cog', separator: true}
      ],
      _current = 'Dashboard';
